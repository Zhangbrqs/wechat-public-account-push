...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxfc0cce5d336d39ab',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'b681c6cc5bbd18d89cf960bbea1fa255',
  ...
  USERS: [
    {
      ...
      id: 'oV4Sd56wtTjJS9KqxDv2MEOgZgSc',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'xZTiWMJImQZuSYsMsElED6iHHKE9jT8pq-wt5UESdWU',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '肇庆',
